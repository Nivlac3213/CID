...
// g++ -o serverApp main.cpp StreamServerCore.cpp SignalDataService.cpp RxwFunctions.cpp SignalProcessor.cpp -lpthread
// clang++ -o serverApp main.cpp StreamServerCore.cpp SignalDataService.cpp RxwFunctions.cpp SignalProcessor.cpp -lpthread -std=c++11
// ^^if running on macOS

// clang++ -o serverApp main.cpp StreamServerCore.cpp SignalDataService.cpp RxwFunctions.cpp SignalProcessor.cpp -lpthread -std=c++14 
// g++ -o serverApp main.cpp StreamServerCore.cpp SignalDataService.cpp RxwFunctions.cpp SignalProcessor.cpp -lpthread -std=c++14 
